...
public class SDBAdapter {
    ...
    public static final int col_cid= 4;
    public static final int col_pw= 5;
    ...
    public SDBAdapter (Context ctx) {
        this.context= ctx;
        myDBHelper= new DatabaseHelper (context);

    }
    public SDBAdapter open () {
    ...
    public long insertRow (String first, String last, int sid, String cid, String pw) {
    ...
    public boolean updateRow (long rowId, String first, String last, int sid, String cid, String pw) {
        String where= key_rowid + "=" + rowId;
